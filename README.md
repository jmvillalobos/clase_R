...
Además, en este curso usaremos R con un ambiente grafico llamado RStudio, que nos permite visualizar tanto el campo de trabajo como las salidas de nuestros diferentes análisis.
